...
def trainer_synapse(args, model, snapshot_path):
    ...
    db_test = Synapse_dataset(base_dir=args.volume_path, split="val_vol_small", list_dir=args.list_dir)
    ...
    for epoch_num in iterator:
        ...
        logging.info('Done with Epoch %f' % (epoch_num))
        ...
        if args.hyp_tuning:
            nni.report_intermediate_result(float(mean_miou))
            if epoch_num == max_epoch - 1:
                nni.report_final_result(float(mean_miou))
