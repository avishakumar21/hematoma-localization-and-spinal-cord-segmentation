...
parser.add_argument('--max_epochs', type=int, default=hyp_params['epochs'], help='maximum epoch number to train')
parser.add_argument('--batch_size', type=int, default=hyp_params['batch'],
...
parser.add_argument('--base_lr', type=float,  default=hyp_params['lr'], help='segmentation network learning rate')
...
def inference(args, model, test_save_path=None):
    db_test = args.Dataset(base_dir=args.volume_path, split="test_vol_small", list_dir=args.list_dir)
